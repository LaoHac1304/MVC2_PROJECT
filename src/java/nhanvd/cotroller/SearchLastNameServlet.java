...
public class SearchLastNameServlet extends HttpServlet {
    /**
     * Processes requesrts for both HTTP <code>GET</code> and <code>POST</code>
     * methods.
     *
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = siteMaps.getProperty(MyApplicationConstants.LoginFeatures.SEARCH_STATIC_PAGE);
        try  {
            ...
            log("SearchLastNameServlet _Naming_ " + ex.getMessage());
        } catch (SQLException ex){
            log("SearchLastNameServlet _SQL_ " + ex.getMessage());
        }
        finally{
