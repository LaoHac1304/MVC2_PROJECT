 ...
 * @author simnh
 */
public class ResgistrationCreateError implements Serializable{
    ...
    public ResgistrationCreateError() {
    }

    public ResgistrationCreateError(String usernameLengthErr, String passwordLengthErr, String fullNameLengthErr, String confirmNotMatched, String usernameIsExisted) {
